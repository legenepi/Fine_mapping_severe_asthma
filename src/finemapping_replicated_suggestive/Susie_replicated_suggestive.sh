...
Rscript src/susie.R \
    /scratch/gen1/nnp5/Fine_mapping/tmp_data/${SNP}.cols_no_header.raw \
    /scratch/gen1/nnp5/Fine_mapping/tmp_data/${SNP}_no_ma_z_scores.txt \
    ${PATH_finemapping}/output/susie_replicated_suggestive/susie_replsugg_${chr}_${SNP}_${start}_${end}.txt \
    ${PATH_finemapping}/output/susie_replicated_suggestive/susie_replsugg_${chr}_${SNP}_${start}_${end}.jpeg

Rscript src/credset_susie.R \
    ${PATH_finemapping}/output/susie_replicated_suggestive/susie_replsugg_${chr}_${SNP}_${start}_${end}.txt \
    /scratch/gen1/nnp5/Fine_mapping/tmp_data/${SNP}_no_ma_GWAS_sumstats.txt \
    ${PATH_finemapping}/output/susie_replicated_suggestive/susie_replsugg_credset.${SNP}.$chr.$start.$end \
