...
#Find the leading SNP (highest PIP) in the region according to finemapping results and variants in the valid credible set:
...
plink --bfile /scratch/gen1/nnp5/Fine_mapping/tmp_data/${SNP} \
    ...
    --out /scratch/gen1/nnp5/Fine_mapping/tmp_data/${snp_lead}_ld_file

Rscript src/finemapping_replicated_suggestive/PIP_plot_with_funcannot_pt2.R \
    /scratch/gen1/nnp5/Fine_mapping/tmp_data/${snp_lead}_ld_file.ld \
