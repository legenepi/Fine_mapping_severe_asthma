...
#maf001_broad_pheno_1_5_ratio_betase_input_mungestat:
    awk -v CHR="$chr" '$2 == CHR {print}' /scratch/gen1/nnp5/Fine_mapping/tmp_data/maf001_broad_pheno_1_5_ratio_betase_input_mungestat | \
...
#python:
    ...
    zcat /home/n/nnp5/PhD/PhD_project/Fine_mapping_severe_asthma/output/manual_finemap.UKB.$chr.$start.$end.gz | tail -n +2 | wc -l
    chr_row=$((chr_row + 2))
    ldref_row=$((ldref_row + 2))
done > /home/n/nnp5/PhD/PhD_project/Fine_mapping_severe_asthma/output/QC_PolyfunSusie.txt
